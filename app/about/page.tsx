  ...
  const teamMembers = [
    {
      ...
      bio: 'Creator of En Croissant, the foundation of Pawn Appétit. Passionate about chess and software development.',
      avatar: '👨‍💻',
      links: {
    ...
    },
    {
      ...
      bio: 'Leading the development of Pawn Appétit with focus on user experience and new features.',
      avatar: '👨‍💻',
      links: {
