    ...
    const platforms = [
        {
            ...
            downloadUrl: 'https://github.com/ChessKitchen/pawn-appetit/releases/latest/download/Pawn.Appetit_0.5.1_x64-setup.exe',
            instructions: [
        ...
        },
        {
            ...
            downloadUrl: 'https://github.com/ChessKitchen/pawn-appetit/releases/latest/download/Pawn.Appetit_0.5.1_x64.dmg',
            instructions: [
        ...
        },
        {
            ...
            downloadUrl: 'https://github.com/ChessKitchen/pawn-appetit/releases/latest/download/Pawn.Appetit_0.5.1_amd64.AppImage',
            instructions: [
