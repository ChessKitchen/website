    ...
    const platforms = [
        {
            ...
            downloadUrl: 'https://github.com/ChessKitchen/pawn-appetit/releases/latest/download/Pawn.Appetit_0.4.0_x64-setup.exe',
            instructions: [
        ...
        },
        {
            ...
            downloadUrl: 'https://github.com/ChessKitchen/pawn-appetit/releases/download/v0.4.0/Pawn.Appetit_0.4.0_x64.dmg',
            instructions: [
        ...
        },
        {
            ...
            downloadUrl: 'https://github.com/ChessKitchen/pawn-appetit/releases/download/v0.4.0/Pawn.Appetit_0.4.0_amd64.AppImage',
            instructions: [
