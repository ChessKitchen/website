    ...
    const platforms = [
        {
            ...
            downloadUrl: 'https://github.com/ChessKitchen/pawn-appetit/releases/latest/download/pawn-appetit_x64_en-US.msi',
            instructions: [
        ...
        },
        {
            ...
            downloadUrl: 'https://github.com/ChessKitchen/pawn-appetit/releases/latest/download/pawn-appetit_x64.dmg',
            instructions: [
        ...
        },
        {
            ...
            downloadUrl: 'https://github.com/ChessKitchen/pawn-appetit/releases/latest/download/pawn-appetit_amd64.AppImage',
            instructions: [
